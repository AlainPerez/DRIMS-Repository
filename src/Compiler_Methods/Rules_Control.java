...
import Rules_Methods.New_Rule_Class;
import Meta_Data_Methods.Attribute;
import Meta_Data_Methods.Manager;
...
public class Rules_Control {
  ...
  private ArrayList<String> labels_ant_con;
    ...
    public Rules_Control() {
        this.compiling_rule = new New_Rule_Class(); // fill linguistic labels; // fill type // fill relation
    ...
    public Manager getMeta() {
        return meta;
    }

    public void setMeta(Manager meta) {
        this.meta = meta;
    }


    public void setCompiling_rule(New_Rule_Class compiling_rule) {
    ...
    public New_Rule_Class getCompiling_rule() {
